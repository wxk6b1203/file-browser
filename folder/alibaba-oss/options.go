...
// Options holds Alibaba Cloud OSS-specific connection parameters.
...
type Options struct {
	...
	// SecurityToken is used for STS temporary credentials (optional).
	SecurityToken string `yaml:"securityToken,omitempty" json:"securityToken,omitempty"`
	// Endpoint overrides the default OSS endpoint, e.g. "https://oss-cn-hangzhou.aliyuncs.com".
	Endpoint string `yaml:"endpoint,omitempty" json:"endpoint,omitempty"`
	// Prefix is prepended to every key, acting as a virtual sub-directory.
	Prefix string `yaml:"prefix,omitempty" json:"prefix,omitempty"`
	// ForcePathStyle forces path-style addressing (https://endpoint/bucket/key).
	ForcePathStyle bool `yaml:"forcePathStyle,omitempty" json:"forcePathStyle,omitempty"`
	// UseCName indicates the endpoint is a CName bound to the bucket.
	UseCName bool `yaml:"useCName,omitempty" json:"useCName,omitempty"`
